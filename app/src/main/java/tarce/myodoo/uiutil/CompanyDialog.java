...
import tarce.myodoo.adapter.QueryComponyAdapter;
...
public class CompanyDialog extends Dialog {
    ...
    private List<ComponyQueryBean.ResultBean.ResDataBean> result;
    private QueryComponyAdapter adapter;
    private GetCompany getCompany;

    public CompanyDialog(@NonNull Context context, List<ComponyQueryBean.ResultBean.ResDataBean> result) {
    ...
    public CompanyDialog(@NonNull Context context, @StyleRes int themeResId, List<ComponyQueryBean.ResultBean.ResDataBean> result) {
        super(context, R.style.MyDialogStyle);
        this.context = context;
        this.result = result;
        inflater = LayoutInflater.from(context);
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                getCompany.getCompanyName(result.get(position).getName(), result.get(position).getId());
                dismiss();
            }
        });
    }
